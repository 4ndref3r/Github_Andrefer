        ...
        <div class="w-full max-w-[26rem] p-4 sm:px-5">
          ...
          <form action="<?php echo constant('URL'); ?>signup/sendConfirmationEmail" method="POST">
            <div class="card mt-5 rounded-lg p-5 lg:p-7">
              ...
              <span class="relative mt-1.5 flex">
                <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Correo electrónico" type="text" name="contra">
                <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                  <svg xmlns="http://www.w3.org/2000/svg" class="size-5 transition-colors duration-200" fill="none" viewbox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mt-4 text-center text-xs+">
              <p class="line-clamp-1">
                ...
                <a class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="<?php echo constant('URL'); ?>">Iniciar sesión</a>
              </p>
            </div>
            <div class="my-7 flex items-center space-x-3">
              <div class="h-px flex-1 bg-slate-200 dark:bg-navy-500"></div>
              <p class="text-tiny+ uppercase">o registrate con</p>
              <div class="h-px flex-1 bg-slate-200 dark:bg-navy-500"></div>
            </div>
